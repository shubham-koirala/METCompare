...
#+ geom_point(data=draw.df[draw.df$class == 'MET500',],aes(x=purity,y=immune.score),color='red',size=9.5) + ylim(0,7)
ggsave(filename = '~/OneDrive/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section5/basal.CD8.immune.score.vs.purity.pdf',width = 20,height=20)
...
#+ geom_point(data=draw.df[draw.df$class == 'MET500',],aes(x=purity,y=adjusted.immune.score),color='red',size=9.5)
ggsave(filename = '~/OneDrive/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section5/basal.CD8.adjusted.immune.score.vs.purity.pdf',width = 20,height=20)
