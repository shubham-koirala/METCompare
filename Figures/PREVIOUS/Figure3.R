...
################################################################################   
# (b,c): boxplot of G1/S and G2/MssGSEA scores
################################################################################   
...
ggsave(filename = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section2/G1.and.S.score.pdf',width = 20,height=20)
...
ggsave(filename = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section2/G2.and.M.score.pdf',width = 20,height=20)
...
################################################################################   
# (a): VennDiagram and GO enrichment 
################################################################################  
...
################################################################################   
# (b):  valadition with SRP253428 (aka GSE147250) dataset (for PRAD)
################################################################################  
...
ggplot(G1.and.S.scroe.df, aes(x=site,y= scale(score), fill=site)) + 
  ...
  geom_point(position=position_jitterdodge(),size=3.0,show.legend = FALSE) + 
  ylab('G1/S ssGSEA score') + ggplot.style  + scale_fill_manual(values = c('primary'='#EF8A62','metastatic'='#D1E5F0')) + ylim(-7,7)
ggsave(filename = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section2/SRP253428.G1.and.S.score.pdf',width = 20,height=20)
...
ggplot(G2.and.M.scroe.df, aes(x=site,y= scale(score), fill=site)) + 
  ...
  geom_point(position=position_jitterdodge(),size=3.0,show.legend = FALSE) + 
  ylab('G2/M ssGSEA score') + ggplot.style  + scale_fill_manual(values = c('primary'='#EF8A62','metastatic'='#D1E5F0')) + ylim(-7,7)
ggsave(filename = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section2/SRP253428.G2.and.M.score.pdf',width = 20,height=20)
...
# }
# pdf(file = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section2/color.bar.pdf',width = 20,height=20)
...
# pdf(file = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section2/lumb.tumor.intrinsic.upregulated.DE.gene.heatmap.pdf',width = 20,height=20)
...
# colnames(tmp) <- colnames(median.tpm.matrix)
# flag          <- which(rowSums(tmp) > 0)
# pdf(file= '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section2/her2.tumor.intrinsic.upregulated.DE.gene.heatmap.pdf',width = 20,height=20)
# Heatmap(tmp[flag,], col=colorRamp2(seq(from=-5,to=5,by=0.5),colorRampPalette(brewer.pal(11, "RdBu"))(21) %>% rev),show_row_names = FALSE,show_column_names = TRUE,show_heatmap_legend = FALSE,cluster_columns =  FALSE)
# dev.off()
# 
...
# colnames(tmp) <- colnames(median.tpm.matrix)
# flag          <- which(rowSums(tmp) > 0)
# pdf(file = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section2/basal.tumor.intrinsic.upregulated.DE.gene.heatmap.pdf',width = 20,height=20)
# Heatmap(tmp[flag,], col=colorRamp2(seq(from=-5,to=5,by=0.5),colorRampPalette(brewer.pal(11, "RdBu"))(21) %>% rev),show_row_names = FALSE,show_column_names = TRUE,show_heatmap_legend = FALSE,cluster_columns =  FALSE)
# dev.off()
# 
...
ggsave(filename = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section2/phase.diff.score.pdf',width = 20,height=20)
...
#
#ggsave(filename = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section2/SRP253428.phase.diff.score.pdf',width = 20,height=20)
