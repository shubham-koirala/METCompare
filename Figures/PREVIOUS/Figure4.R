...
##############################################################################
# (c):  using survival analysis to identify metastasis driver and suppressor
##############################################################################
load('client-side/output/DE.gene.clinics.R.output/DE.gene.clinics.RData')
...
ggsave(filename = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/PRAD.up.gene.survival.volcano.plot.pdf',width = 20,height=20)
...
ggsave(filename = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/PRAD.dn.gene.survival.volcano.plot.pdf',width = 20,height=20)
...
plt <- draw.KM.plot(g1)
pdf(file ='~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/PRAD.ATP1B1.KM.plot.pdf',width=20,height=15)
print(plt[[1]])
dev.flush()
dev.off()

plt <- draw.KM.plot(g2)
pdf(file ='~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/PRAD.SPAG5.KM.plot.pdf',width=20,height=15)
print(plt[[1]])
dev.flush()
dev.off()
...
plt <- draw.KM.plot(g1)
pdf(file ='~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/PRAD.ADH5.KM.plot.pdf',width=20,height=15)
print(plt[[1]])
dev.flush()
dev.off()

plt <- draw.KM.plot(g2)
pdf(file ='~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/PRAD.AP003352.1.KM.plot.pdf',width=20,height=15)
print(plt[[1]])
dev.flush()
dev.off()
...
# ggsave(filename = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/lumb.log2FC.MP.and.normal.pdf',width = 20,height=20)
# 
# 
# #######################################################
...
# rownames(df)  <- c.gene
# ggplot(df,aes(x=x,y=y)) + geom_point(size=2.5) + ggplot.style + ylab('log2FC (MET.vs.PRI)') + xlab('log2FC (LIVER.vs.PRI)') + xlim(c(-15,22)) + ylim(c(-15,22)) + geom_abline(intercept = 0,slope=1) + geom_vline(xintercept =psi,linetype=2,size=2) + geom_line(aes(x=x,y=fitted),col='red',lwd=3.5)
# ggsave(filename = '~/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/SRP043470.log2FC.MP.and.normal.pdf',width = 20,height=20)
# 
# 
# #######################################################
...
# rownames(df)  <- c.gene
# ggplot(df,aes(x=x,y=y)) + geom_point(size=2.5) + ggplot.style + ylab('log2FC (MET.vs.PRI)') + xlab('log2FC (LIVER.vs.PRI)') + xlim(c(-15,22)) + ylim(c(-15,22)) + geom_abline(intercept = 0,slope=1) + geom_vline(xintercept =psi,linetype=2,size=2) + geom_line(aes(x=x,y=fitted),col='red',lwd=3.5)
# ggsave(filename = '~/OneDrive/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/her2.log2FC.MP.and.normal.pdf',width = 20,height=20)
# 
# 
# #######################################################
...
# 
# ggsave(filename = '~/OneDrive/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/DE.gene.subtype.specificity.pdf',width = 20,height=20)
...
# 
# pdf(file ='~/OneDrive/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/her2.eg.up.gene.KM.plot.pdf',width=20,height=15)
# print(her2.eg.up.gene.KM.plot[[1]])
# dev.off()
# her2.survival.rs.up[her2.eg.up.gene,]
# 
# pdf(file ='~/OneDrive/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/her2.eg.dn.gene.KM.plot.pdf',width=20,height=15)
...
# 
# pdf(file ='~/OneDrive/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/lumb.eg.up.gene.KM.plot.pdf',width=20,height=15)
# print(lumb.eg.up.gene.KM.plot[[1]])
# dev.off()
# lumb.survival.rs.up[lumb.eg.up.gene,]
# 
# 
# pdf(file ='~/OneDrive/OneDrive - Michigan State University/Project/BreastCancerMetaPotenial/Manuscript/Manuscript/section.Figure/Section3/lumb.eg.dn.gene.KM.plot.pdf',width=20,height=15)
